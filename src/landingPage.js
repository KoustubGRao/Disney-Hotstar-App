...
const LandingPage = () => {
    ...
    return ( 
        ...
        <div className="landing-page">
            ...
            <div className="card">
                <div className="disney_logo_landing"><div><img src="\landingTop.svg"></img></div></div>
                <div className="explore"><Link to='/'><button >Explore</button></Link></div>
                ...
                <div className="Images"><img src="\landingBottom.png"></img></div>
            </div>
